...
<body style="   background-image: url('https://wallpaperset.com/w/full/5/3/8/9809.jpg');
    ...
    <!-- nav bar  -->
        ...
        <header class="p-3 mb-3  text-bg-dark d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <img src="image/pngegg.png" alt="" class="ps-3" style=" width:50px">
    <div class="container ">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li><a href="#stati" class="nav-link px-2 text-white">Statistique</a></li>
